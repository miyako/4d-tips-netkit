...
GoogleのOauthは[セキュリティのチェック](https://developers.google.com/terms/api-services-user-data-policy)が厳しく，[Googleの検証プロセス](https://support.google.com/cloud/answer/7454865)に合格するまでアプリの連携はブロックされます。
